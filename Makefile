...
GUI_SRCS = src/gui/main/main.cpp src/gui/main/machine_selector.cpp src/gui/main/register_pane.cpp \
           ...
           src/gui/main/cartridge_pane.cpp src/gui/main/screen_pane.cpp \
...
TEST_SRCS = tests/test_main.cpp src/libcore/test/test_libcore.cpp \
            ...
            src/libdevices/test/test_joystick.cpp src/plugins/devices/via6522/test/test_via6522.cpp \
            tests/test_plugin_extension.cpp tests/test_vice_importer.cpp \
...
DEVICE_TEST_OBJS = src/plugins/devices/via6522/main/via6522.o \
                   ...
                   src/gui/main/screen_pane.o

$(TEST_BIN): $(TEST_SRCS) $(LIBS) $(PLUGIN_6502_OBJS) $(DEVICE_TEST_OBJS) | $(BINDIR)
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(WXCXXFLAGS) -Itests -rdynamic -o $@ $(TEST_SRCS) \
	    ...
	    $(PLUGIN_6502_OBJS) $(DEVICE_TEST_OBJS) $(BASE_LIBS) $(WXLIBS)

# Target-specific includes/flags
$(GUI_OBJS) src/gui/main/screen_pane.o: INCLUDES += $(WXCXXFLAGS)

# Machine plugins and importers need GUI flags for their plugin_init and panes
src/plugins/machines/vic20/main/plugin_init.o \
src/plugins/machines/c64/main/plugin_init.o \
src/plugins/machines/pet/main/plugin_init.o \
src/plugins/viceImporter/main/rom_import_pane.o: INCLUDES += $(WXCXXFLAGS)

# All plugin objects see the public include surface
# Note: Use += to avoid overwriting previous target-specific INCLUDES
$(PLUGIN_6502_OBJS) $(PLUGIN_VIA6522_OBJS) $(PLUGIN_VIC6560_OBJS) \
$(PLUGIN_KBDVIC20_OBJS) $(PLUGIN_VIC20_CORE_OBJS) $(PLUGIN_VIC20_GUI_OBJS) \
$(PLUGIN_C64PLA_OBJS) $(PLUGIN_CIA6526_OBJS) $(PLUGIN_VIC2_OBJS) \
$(PLUGIN_SID6581_OBJS) $(PLUGIN_C64_CORE_OBJS) $(PLUGIN_C64_GUI_OBJS) \
$(PLUGIN_PIA6520_OBJS) $(PLUGIN_CBMLOADER_OBJS) $(PLUGIN_CRTC6545_OBJS) \
$(PLUGIN_PETVIDEO_OBJS) $(PLUGIN_PET_OBJS) $(PLUGIN_VICEIMPORTER_OBJS): \
    INCLUDES += -Isrc -Isrc/include -Isrc/gui/main \
